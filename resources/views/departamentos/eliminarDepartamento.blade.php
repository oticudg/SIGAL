<div class="modal-header">
    <h3 class="modal-title"><span class="glyphicon glyphicon-trash text-danger"></span> Eliminar Departamento</h3>
</div>
<div class="modal-body">

	<alert ng-repeat="alert in alerts" type="{#alert.type#}" close="closeAlert($index)">{#alert.msg#}</alert>

	<center><h3 ng-show="btnVisivilidad">Esta seguro que desea eliminar este departamento <i class="fa fa-question-circle text-danger" aria-hidden="true"></i></h3></center>
