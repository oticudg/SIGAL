<div class="modal-header">
    <h3 class="modal-title"><span class="glyphicon glyphicon-remove text-danger"></span> Eliminar Rol</h3>
</div>
<div class="modal-body">

	<alert ng-show="alert" type="{#alert.type#}" close="closeAlert()">{#alert.msg#}</alert>

	<center><h3 ng-show="btnVisivilidad">Esta seguro que desea borrar este rol</h3></center>
