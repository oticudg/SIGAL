    ...
    <div class="row">
    	<div class="col-md-6">
		    <h3 class="modal-title">
		    	<span class="fa fa-arrow-circle-right text-warning"></span> Pro-Forma de entrada: <strong class="text-primary"><i class="fa fa-barcode"></i> {#nota.codigo | codeforma#}</strong>
		    </h3>
		  </div>
      <div style="text-align:right" class="col-md-offset-4 col-md-2">
        ...
        @if(Auth::user()->hasPermissions(['inventory_report']))
		  <a class="btn btn-warning" data-toggle="tooltip" data-placement="bottom" title="Generar reporte" href="/reportes/entrada/{#nota.id#}" target="_blank">
	...
	<table class="table table-bordered custon-table-bottom-off" >
		<thead>
			<tr>
				...
				<th class="col-md-2"><i class="fa fa-user"></i> Usuario</th>
			</tr>
		</thead>
		<tbody>
			<tr>
