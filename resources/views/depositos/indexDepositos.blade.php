							...
							<tbody>
								<tr dir-paginate="deposito in depositos | filter:busqueda | itemsPerPage:cRegistro">
									...
									@if( Auth::user()->hasPermissions(['stores_delete']) )
										<td class="text-center"><button class="btn btn-danger" ng-click="eliminarDeposito(deposito.id)"><span class="glyphicon glyphicon-remove"></span> Eliminar</button></td>
									@endif
								</tr>
							</tbody>
						</table>
