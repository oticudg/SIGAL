<div class="modal-header">
    <h3 class="modal-title"><span class="glyphicon glyphicon-remove text-danger"></span> Eliminar Almacén</h3>
</div>
<div class="modal-body">

	<alert ng-repeat="alert in alerts" type="{#alert.type#}" close="closeAlert($index)">{#alert.msg#}</alert>

	<center><h3 ng-show="btnVisivilidad">Esta seguro que desea borrar este almacén</h3></center>
