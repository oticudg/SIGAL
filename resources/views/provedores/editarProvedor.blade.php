<div class="modal-header">
    <h3 class="modal-title"><span class="glyphicon glyphicon-pencil text-warning"></span> Editar proveedor</h3>
</div>
<div class="modal-body">
	...
	<center>
		<h3 class="text-warning"><i class="fa fa-certificate"></i> RIF:<strong> {#rif#}</strong></h3>
	</center>
