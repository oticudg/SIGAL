	...
	<div class="row">
		<div class="col-md-4">
			<select class="form-control" ng-model="deposito">
				...
				<option value="alimentocion">Alimentacion</option>
				<option value="farmacia">Farmacia</option>
			</select>
		</div>

		<div class="col-md-8">
			<textarea  class="form-control" placeholder="Descripcion" ng-model="descipcion" style="width:570px; max-width:570px;"></textarea>
		</div>
	</div>
