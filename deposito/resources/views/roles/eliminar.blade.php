<div class="modal-header">
    <h3 style="color:#C93A36;" class="modal-title"><span class="glyphicon glyphicon-remove"></span> Eliminar Rol</h3>
</div>
<div class="modal-body">

	<alert ng-show="alert" type="{#alert.type#}" close="closeAlert()">{#alert.msg#}</alert>

	<center><h3 class="text-danger" ng-show="btnVisivilidad">Esta seguro que desea borrar este rol</h3></center>
